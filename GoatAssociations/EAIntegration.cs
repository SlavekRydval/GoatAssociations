...
namespace GoatAssociations
{
    public class EAIntegration
    {
        private ViewModel.AddinMainViewModel goatAddinMainViewModel = null;
        ...
        {
            goatAddinMainViewModel = new ViewModel.AddinMainViewModel(Repository, new DialogService());
            return "";
        }
        ...
        {
            goatAddinMainViewModel.Repository = null; 
            GC.Collect();
        ...
        /// </summary>
        /// <param name="Repository"></param>
        public void EA_FileNew(EA.Repository Repository) => goatAddinMainViewModel.Repository = Repository;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="Repository"></param>
        public void EA_FileOpen(EA.Repository Repository) => goatAddinMainViewModel.Repository = Repository;
        ...
        public void EA_GetMenuState(EA.Repository Repository, string Location, string MenuName, string ItemName, ref bool IsEnabled, ref bool IsChecked)
        {
            ...
            {
                case menuItemAbout:
                    IsEnabled = goatAddinMainViewModel.AboutCommand.CanExecute(null);
                    break;
                default:
                    IsEnabled = false;
                    break;
        ...
        public void EA_MenuClick(EA.Repository Repository, string Location, string MenuName, string ItemName)
        {
            ...
            {
                case menuItemAbout:
                    goatAddinMainViewModel.AboutCommand.Execute(null);
                    break;
                default:
